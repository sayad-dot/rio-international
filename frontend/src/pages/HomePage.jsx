        ...
        <div className="relative z-10 w-full container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-20">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              {/* Main Headline */}
              <div>
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-bold text-white mb-3 sm:mb-4 md:mb-6 leading-tight">
                  Your Gateway to World Travel
                </h1>
                <div className="max-w-2xl">
                  <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 leading-relaxed mb-2">
              ...
              <div className="relative bg-gradient-to-br from-white via-white to-primary-50/30 rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 shadow-2xl border border-primary-100/50 overflow-hidden">
                ...
                <div className="relative">
                  <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 md:mb-6">
                    <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gradient-to-br from-primary-500 to-primary-600 rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                      <Sparkles className="h-5 w-5 sm:h-5.5 sm:w-5.5 md:h-6 md:w-6 text-white" />
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900">Start Your Journey</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <button 
                      ...
                      className="w-full bg-gradient-to-r from-primary-500 via-primary-600 to-primary-700 hover:from-primary-600 hover:via-primary-700 hover:to-primary-800 text-white px-5 sm:px-6 md:px-8 py-3.5 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg flex items-center justify-center gap-2 sm:gap-3 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-primary-500/40 hover:-translate-y-1 group mt-4 sm:mt-5 md:mt-6 min-h-[44px]"
                    >
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-3 mt-6 sm:mt-7 md:mt-8 pt-5 sm:pt-6 border-t border-gray-200/50">
                    <div className="text-center group cursor-pointer">
                      <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                        <Globe className="h-4 w-4 sm:h-5 sm:w-5 text-primary-600" />
                      </div>
                      <div className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">50+</div>
                      <div className="text-[10px] sm:text-xs text-gray-500 font-medium">Countries</div>
                    </div>
                    <div className="text-center group cursor-pointer">
                      <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-accent-100 to-accent-200 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                        <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-accent-600" />
                      </div>
                      <div className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-accent-600 to-accent-700 bg-clip-text text-transparent">98%</div>
                      <div className="text-[10px] sm:text-xs text-gray-500 font-medium">Success Rate</div>
                    </div>
                    <div className="text-center group cursor-pointer">
                      <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-secondary-100 to-secondary-200 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform">
                        <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-secondary-600" />
                      </div>
                      <div className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-secondary-600 to-secondary-700 bg-clip-text text-transparent">7-15</div>
                      <div className="text-[10px] sm:text-xs text-gray-500 font-medium">Days</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-5 md:space-y-6">
              <div className="text-center lg:text-left mb-3 sm:mb-4 md:mb-6">
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-display font-semibold text-white mb-2 sm:mb-3">
